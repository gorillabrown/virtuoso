...
## Unreleased — acceptance and evidence reconciliation

**Additive. No breaking changes; registry schema stays at v2.** Step 1 of the close-out
...
- Seven anchors added to `scripts/skill_rules.py` hold these rules in the skill body, so
  ...
  `pointer-closeout` joins the skills covered.
